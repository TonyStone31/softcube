...
begin
  ...
  begin
    ...
    begin
      ...
      Inc(depth);
      WriteProgress('Phase1', fName, done, B_24_8 * 256);
...
begin
  ...
  begin
    WriteLnVerbose('Creating ' + fName);
    WriteLnVerbose('This will take several hours.');
    ...
    begin
      ...
      WriteLnVerbose(IntToStr(testCount[0]));
    end;//k

    WriteLnVerbose('Writing ' + fName);
    fs := TFileStream.Create(TableDir + fName, fmCreate);
    for i := 0 to N_SYMCENTCOORD * 256 - 1 do
    begin
      used := UDStates10Table[i].used;
    ...
    fs.Free;
    WriteLnVerbose('Finished writing ' + fName);
  end;
  SetLength(savearr, 0);
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      Inc(depth);
      WriteProgress('Phase1', fName, done, B_24_8 * 16);
