...
type
  ...
  Axis = (U = 0, D, R, L, F, B);
  // f-moves are facemoves, x-moves and y-moves are moves of the x-y-orbit slices
...
const
  ...
  B_24_12 = 2704156;
  N_SYMCENTCOORD = 92247;
  N_SYMBRICKCOORD = 46935;
  N_SYMBRICK702COORD = 690;
